...
<div class="form-group">
  ...
  <input type="radio" name="variant" value="Variant1" class="check_in">Tour infernale
  <br>
  <input type="radio" name="variant" value="Variant2" class="check_in">Nuage de symbole
  <br>
...
<input type="submit" class="btn btn-primary" value="Créer une partie" />
</form>`;

const AddFilmPage = () => {
  setLayout("Create party");
