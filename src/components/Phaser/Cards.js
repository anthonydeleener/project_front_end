...
class Cards {
  ...
  constructor() {
    this.cards = [[1, 2, 3, 4, 5, 6, 7, 50], [8, 9, 10, 11, 12, 13, 14, 50], [15, 16, 17, 18, 19, 20, 21, 50],[22, 23, 24, 25, 26, 27, 28, 50], [29, 30, 31, 32, 33, 34, 35, 50],
  ...
  getCards(nbre) {
      return this.cards.slice(0,nbre);
