...
class GameOverScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(this.cameras.main.centerX, this.cameras.main.centerY - 50, "Ton temps : " + this.timer, { fontFamily: 'Comic Sans MS', fontSize: '56px', color: 'black' }).setOrigin(0.5);
